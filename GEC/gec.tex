...
%% Trim out/down first two paragraphs which were the abstract
%% Remove discussion that is repeated (or move it to) the introduction
%% Add context/motivation to entire thesis work
...
%% Needed?
%% Add more speculation on future possible work
