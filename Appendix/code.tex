...
\begin{center}
\begin{tabular}{|p{1.5in}|p{1.25in}|p{3.25in}|}
...
\hline
\rule{0pt}{3ex}
Energy Processing	&bootstrap.git	&	Corresponds to $\sim$/matlab/Bootstrap \\ 

\hline
\rule{0pt}{3ex}
Detection Efficiency	&de.git	&	Corresponds to $\sim$/matlab/detection\_efficiency\\ 
