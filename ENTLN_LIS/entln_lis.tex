...
The timing offset, Figure~\ref{entln_lis:fig:accuracy}a, is sharply peaked at -1.9~ms, with ENTLN timing occurring before the LIS flash time, the median timing offset is 2.3~ms.
...
The median distance offset from the flash centroid is 7.0~km, as seen Figure~\ref{entln_lis:fig:accuracy}b.
