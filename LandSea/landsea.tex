...
%% MM: Both (above) the linear regression of the log10 value cannot both be true
...
%% MM: Go through, or elaborate, on the low energy side of things.  Explain why low energy increase can be ignored
