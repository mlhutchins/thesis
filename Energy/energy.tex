%% Convert all powers to energies
%% Change tense to something completed

\section{Overview}

%% Turn into introductory paragraph of why we want Energy
...
%% MM: In fact, sound cards vary by a factor of 'X' in their sensitivity
%% MM: How bad was this assumptions
...
%% Update to 2 degree or possibly 1 degree image
...
%% Update median energy to present
