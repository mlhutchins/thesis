...
The appendices discuss the code implementation of the techniques described in a few of the chapters along with the construction, design, and operation of the WWLLN stations.
The descriptions are given in Table~\ref{intro:table:outline_appendix}.
...
Describes the different types of WWLLN data files available, their location, and the common code used in this thesis.
\\ 
...
Describes the development, design, and construction of the WWLLN Service Unit v4.
\\  
