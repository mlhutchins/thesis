...
However the air can breakdown in $\sim$100~m steps, creating a continuous ionized plasma channel; the breakdown process is semi-random with steps occurring until an oppositely charged region is connected.
