%% MM:   More of a "what I did".  E.g.: My research started with the WWLLN network consisting of uncalibrated RMS energy values and stroke locations and implemented new methods to allow for new and extended analysis with the WWLLN dataset.  To prove and validate the new techniques they were applies to previously solved or measure problems, measurements often made in limited extent or duration, and made a modern measurement using the lightning network.
...
%% MM: (not a comment by stemmed from one of them) Mention existing systems or limitations?
